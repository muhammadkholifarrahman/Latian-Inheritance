...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Kholif", 19);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Kamarudin", 36, "1807765", "Pemograman");
            teacher.GetNameAndAge();

            Student student = new Student("Muhammad Kholif Arrahman", 19, "19.11.2799", "muhammad.2799@students.amikom.ac.id");
